...
## Трассировка маршрута с использованием ICMP (8 баллов) - done
...
### Задание А. Основное приложение (6 баллов) - done
...
### Задание Б. Вывод имен промежуточных узлов (2 балла) - done
...
## Дистанционно-векторная маршрутизация (8 баллов) - done
...
### Задание В (опционально) (2 балла) - done
...
## Использование протокола IPv6 (2 балла) - done
...
## Удаленное рисование (6 баллов) - done
