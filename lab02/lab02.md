...
`поддерживается и json-формат и form-data, поэтому в примерах присутствуют оба, но результат будет аналогичным, если вместо form-data направлять json-файл`
